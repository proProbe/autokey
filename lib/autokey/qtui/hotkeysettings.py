...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.capslockButton = KPushButton(Form)
        self.capslockButton.setCheckable(True)
        self.capslockButton.setChecked(False)
        self.capslockButton.setObjectName(_fromUtf8("capslockButton"))
        self.horizontalLayout.addWidget(self.capslockButton)
    ...
    def retranslateUi(self, Form):
        ...
        self.capslockButton.setText(kdecore.i18n(_fromUtf8("CapsLock")))
